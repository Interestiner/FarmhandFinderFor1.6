        ...
        *********/
        ...
        private int GenerateHeadHash()
        {
            ...
            var headHash = HashCode.Combine(
                baseTextureValue, _farmer.newEyeColor, _farmer.skin, _farmer.hair, _farmer.hairstyleColor, _farmer.hat, _farmer.accessory);
        ...
        private Texture2D GenerateTexture()
        {
            ...
            using (var spriteBatch = new SpriteBatch(graphicsDevice))
            {
                ...
                Utility.DrawUiSprite(spriteBatch, backgroundTexture, offset, 0.75f, 0f, 1.0f);
                Utility.DrawFarmerHead(spriteBatch, _farmer, offset, 0.75f);
                Utility.DrawUiSprite(spriteBatch, foregroundTexture, offset, 0.75f, 0f, 1.0f);
